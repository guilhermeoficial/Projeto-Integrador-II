...
CREATE TABLE usuarios (
    ...
    cpf VARCHAR(14) NOT NULL UNIQUE,  -- Mantém formato, limpa no backend
    email VARCHAR(120) NOT NULL UNIQUE,
    senha VARCHAR(6) NOT NULL,        -- Senha texto plano (CORRIJA depois!)
...
('Paulo Junior', '00000000000', 'paulo@email.com', '123456', 'ADMINISTRADOR'),
('Ana Santos', '11111111111', 'ana@email.com', '654321', 'USUARIO'),
('Victor Pereira', '22222222222', 'victor@email.com', '111222', 'USUARIO'),
('Guilherme Oliveira', '14867590880', 'guilhermeoliveiraifrn@email.com', '112358', 'USUARIO');
...
SELECT * FROM usuarios WHERE cpf = '00000000000';